...
\begin{document}
\maketitle
\section{Quand est-ce que $\tilde\Or_K$ est de Dedekind}
...
Le reste se montrer toujours directement.

\subsection{Cas général}
Le fait que c'est intégralement clos c'est clair. Faut montrer que
c'est de dimension $1$. Ça c'est l'étude des $\Spec$.
